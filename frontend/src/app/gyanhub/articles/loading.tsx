  ...
  return (
    <div className="min-h-screen bg-[#050505] text-slate-100 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-20">
        <div className="w-48 h-8 bg-white/5 rounded-xl animate-pulse mb-4" />
        <div className="w-72 h-4 bg-white/5 rounded-lg animate-pulse mb-12" />
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="bg-white/[0.02] rounded-[2.5rem] p-8 border border-white/5 h-56 animate-pulse" />
          ))}
        </div>
      </div>
    </div>
