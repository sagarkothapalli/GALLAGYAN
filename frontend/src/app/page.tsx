...
export default function Home() {
  ...
  const fetchStock = async (symbol: string) => {
    setLoading(true); setError(''); setShowSuggestions(false); setActiveTab('chart'); setHistory([]); setNews([]); setFundamentals([]); setActions(null); setPeersData(null); setProfile(null);
    try {
