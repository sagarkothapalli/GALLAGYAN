...
export default function Home() {
  ...
  const fetchStock = async (symbol: string) => {
    setLoading(true); setError(''); setShowSuggestions(false); setActiveTab('chart'); setHistory([]); setNews([]); setFundamentals([]); setActions(null); setPeersData(null); setProfile(null); setComparisonData(null); setCalendar(null);
    try {
      ...
      const [newsRes, fundRes, actionRes, peerRes, profileRes, calRes] = await Promise.all([fetch(`${baseUrl}/api/stock/${cleanSymbol}/news`), fetch(`${baseUrl}/api/stock/${cleanSymbol}/fundamentals`), fetch(`${baseUrl}/api/stock/${cleanSymbol}/actions`), fetch(`${baseUrl}/api/stock/${cleanSymbol}/peers`), fetch(`${baseUrl}/api/stock/${cleanSymbol}/profile`), fetch(`${baseUrl}/api/stock/${cleanSymbol}/calendar`)]);
      if (newsRes.ok) setNews(await newsRes.json());
